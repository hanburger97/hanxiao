...
const Scene = () => {
  ...
  return (
    React.createElement('group', null,
      ...
      React.createElement('directionalLight', {position: [-0.25, -1, 0.5], color: OCEAN, intensity: 0.9}),
      React.createElement('directionalLight', {position: [1, 0, 0], color: INDIGO, intensity: 0.7}),
